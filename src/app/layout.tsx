...
export const metadata: Metadata = {
  ...
  description:
    "010-5877-4440, 부산, 서면, 해운대, 동래, 남포동, 연산동, 광안리, 수영구, 김해, 양산, 기장 출장 마사지 서비스를 제공합니다. 010-5877-4440 30분 이내 신속 방문, 전문 테라피스트의 고품격 힐링 케어로 편안한 휴식을 경험하세요. 현금, 카드, 계좌이체 모든 결제 방법 가능합니다.",
  keywords:
    "부산 출장 마사지, 서면 출장 마사지, 해운대 출장 마사지, 남포동 출장 마사지, 연산동 출장 마사지, 광안리 출장 마사지, 수영구 출장 마사지, 김해 출장 마사지, 양산 출장 마사지, 기장 출장 마사지, 출장 마사지 서비스, 부산 마사지, 홈케어 마사지, 힐링 마사지",
